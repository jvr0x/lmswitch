...
from lmswitch.runtimes.llama_dual import LlamaDualRuntime
...
runtime_registry.register("llama-dual", LlamaDualRuntime)
...
runtime_registry.register("sglang-dual", SGLangDualRuntime)
